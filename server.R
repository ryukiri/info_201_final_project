...
shinyServer(function(input, output) {
  ...
  all.features <- list(
      ...
      'features.2011' = X.features.2011,
      'features.2012' = X.features.2012,
      'features.2013' = X.features.2013,
      'features.2014' = X.features.2014,
      'features.2015' = X.features.2015,
      'features.2016' = X.features.2016
  )
